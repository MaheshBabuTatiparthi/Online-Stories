...
-- CREATE DATABASE IF NOT EXISTS `heroku_52660a9821aa525` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
-- USE `heroku_52660a9821aa525`;


-- Backup categories table
-- CREATE TABLE IF NOT EXISTS `categories_backup_1602860175` LIKE `categories`;
-- INSERT INTO `categories_backup_1602860175` SELECT * FROM `categories`;
...
-- CREATE TABLE IF NOT EXISTS `stories_backup_1602860175` LIKE `stories`;
-- INSERT INTO `stories_backup_1602860175` SELECT * FROM `stories`;
...
CREATE TABLE IF NOT EXISTS `stories` (
	...
	`story_content` longtext NOT NULL DEFAULT '',
